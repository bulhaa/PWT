...
enum_a(table_name_singular = 1, table_name_plural = 2, reverse = 0){
	...
	data := "`tEdit�Edit`tCopy�Copy`tDelete�Delete`t1000`tNormal`tgreen`t`tNULL`tNULL`tNULL`tNULL`tNULL`n`tEdit�Edit`tCopy�Copy`tDelete�Delete`t2000`tConfidential`tred`t`tNULL`tNULL`tNULL`tNULL`tNULL`n"
