...
;~ else if(Stack="11h") ; Get Property Information 
	...
	{
		Button1_Label=7/8/2019 @ 23`:11`:41`nWD MyCloud`t0.008026691153645515`nHammadh PC`t2.785182300955057`nLatheef PC`t2.7630009530112147`nHP LaserJet`t0.00036900024861097336`nReception Laptop`t3.240807458758354`nModebe PC`t1.213752243667841`nCamera System`t5.21540641784668e-7`nAcer ES14 mobile laptop`t0.7185092670843005`nHammadh J7 Pro`t0.5828269282355905`nThihthibey iPhone 8 Plus`t1.1483220625668764`nAfsara 300119`t7.281941170804203`nHammadh PC 2`t0.000005163252353668213`nLatheef Ipad`t0.6308052437379956`nBilal Desktop`t0.7174115069210529`nHewage Laptop Dell`t4.721385113894939`nAmrita`t7.759715618565679`nBilal 20190629`t2.3511843802407384`nCenie`t1.2237749947234988`nHewage new Desktop`t1.3068536929786205`nAmrita Tablet`t6.506561415269971`nAmrita Phone 20190806`t2.5384561121463776`n146`t0.014432569965720177`nwifi router`t0.0000727623701095581`n`n
	}
...
XButton2::
	...
	{
		waitClipboard(copy, 1, encodeAsSingleElement, copyResult)
	}
	...
	if(step == 1){
		loop 10
		{
			...
			{
				Send {Tab}{Space}{Tab}{Space}{Tab 2}
				showTT=0
				Send 20
				sleep 200
				Send {Tab}
